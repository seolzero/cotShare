...
public class JdbcSinkConfig extends AbstractConfig {
  ...
  private static final String DATA_TYPE_DEFAULT = "null";
  private static final String DATA_TYPE_DOC =
      "DATA_TYPE.\n For example: digital_object, sensor, ...";
  private static final String DATA_TYPE_DISPLAY = "data type";
  
  public static final String CONNECTION_KAFKA_HOST = "connection.Kafka.Host";
  private static final String CONNECTION_KAFKA_HOST_DEFAULT = "localhost";
  private static final String CONNECTION_KAFKA_HOST_DOC =
      "CONNECTION_KAFKA_HOST.\n For example: localhost";
  private static final String CONNECTION_KAFKA_HOST_DISPLAY = "connection Kafka Host";
  ...
  public static final ConfigDef CONFIG_DEF = new ConfigDef()
        ...
        .define(
            ...
            CONNECTION_KAFKA_HOST,
            ConfigDef.Type.STRING,
            CONNECTION_KAFKA_HOST_DEFAULT,
            ConfigDef.Importance.HIGH,
            CONNECTION_KAFKA_HOST_DOC,
            CONNECTION_GROUP,
            8,
            ConfigDef.Width.SHORT,
            CONNECTION_KAFKA_HOST_DISPLAY
        )
        // Writes
        .define(
            INSERT_MODE,
  ...
  public final String connectionKafkaHost;
  ...
  public JdbcSinkConfig(Map<?, ?> props) {
    ...
    connectionKafkaHost = getString(CONNECTION_KAFKA_HOST);
