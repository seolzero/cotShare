...
COPY public.simulations (digital_twin_id, simulation_id, simulation_name, description, keywords, subjects, creation_time, modification_time, simulation_access_url, "authorization", simulation_request_param, simulation_response_info, response_format_type, interface_type, error_info, preliminary_field) FROM stdin;
\.
